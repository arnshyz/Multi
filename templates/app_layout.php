<?php
$appPageKey = $appPageKey ?? 'profile';
$appTitle = $appTitle ?? 'AKAY.IO – AI Hub';
$appInitialView = $appInitialView ?? 'viewDashboard';
$appInitialFeature = $appInitialFeature ?? '';
$appAllowedViews = $appAllowedViews ?? [];
$shouldRenderView = static function (string $viewId) use ($appAllowedViews) {
    return !$appAllowedViews || in_array($viewId, $appAllowedViews, true);
};
?>
<!DOCTYPE html>
<html lang="id">
...
<div class="workspace sidebar-open">
  ...
  <nav class="sidebar-nav">
    <button class="sidebar-link<?= $appPageKey === 'profile' ? ' active' : '' ?>" data-target="viewDashboard" data-navigate="page" data-href="Profile.php">
    ...
    <button class="sidebar-link<?= $appPageKey === 'account' ? ' active' : '' ?>" data-target="viewAccount" data-navigate="page" data-href="Pengaturan%20Akun.php">
      <span class="nav-icon" aria-hidden="true">
    ...
    <button class="sidebar-link<?= $appPageKey === 'drive' ? ' active' : '' ?> hidden" data-target="viewDrive" data-navigate="page" data-href="Drive.php" id="driveNavButton">
      <span class="nav-icon" aria-hidden="true">
    ...
    <button class="sidebar-link<?= $appPageKey === 'filmmaker' ? ' active' : '' ?>" data-target="viewFilm" data-feature="filmmaker" data-navigate="page" data-href="Filmmaker.php">
      <span class="nav-icon" aria-hidden="true">
    ...
    <button class="sidebar-link<?= $appPageKey === 'ugc' ? ' active' : '' ?>" data-target="viewUGC" data-feature="ugc" data-navigate="page" data-href="UGC%20Tool.php">
      <span class="nav-icon" aria-hidden="true">
    ...
    <button class="sidebar-link<?= $appPageKey === 'imageGen' ? ' active' : '' ?>" data-target="viewHub" data-feature="imageGen" data-navigate="page" data-href="Image%20Generator.php">
      <span class="nav-icon" aria-hidden="true">
    ...
    <button class="sidebar-link<?= $appPageKey === 'imageEdit' ? ' active' : '' ?>" data-target="viewHub" data-feature="imageEdit" data-navigate="page" data-href="Image%20Editing.php">
      <span class="nav-icon" aria-hidden="true">
    ...
    <button class="sidebar-link<?= $appPageKey === 'videoGen' ? ' active' : '' ?>" data-target="viewHub" data-feature="videoGen" data-navigate="page" data-href="Video%20Generator.php">
      <span class="nav-icon" aria-hidden="true">
    ...
    <button class="sidebar-link<?= $appPageKey === 'lipsync' ? ' active' : '' ?>" data-target="viewHub" data-feature="lipsync" data-navigate="page" data-href="Lipsync%20Studio.php">
      <span class="nav-icon" aria-hidden="true">
...
<?php if ($shouldRenderView('viewDashboard')): ?>
...
<?php if ($shouldRenderView('viewDrive')): ?>
...
<?php if ($shouldRenderView('viewAccount')): ?>
...
<?php if ($shouldRenderView('viewHub')): ?>
...
<?php if ($shouldRenderView('viewFilm')): ?>
...
<?php if ($shouldRenderView('viewUGC')): ?>
...
<script>
  ...
  navButtons.forEach(btn => {
    btn.addEventListener('click', () => {
      ...
      if (btn.dataset.navigate === 'page' && btn.dataset.href) {
  ...
  const initialView = document.body ? (document.body.dataset.initialView || 'viewDashboard') : 'viewDashboard';
  const initialFeature = document.body ? (document.body.dataset.initialFeature || undefined) : undefined;
  showView(initialView, initialFeature || (initialView === 'viewHub' ? currentFeature || 'imageGen' : undefined));
